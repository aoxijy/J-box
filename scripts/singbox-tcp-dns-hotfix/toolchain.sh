...
toolchain_cache=${JBOX_TOOLCHAIN_CACHE:-"$hotfix_dir/../../.build-cache/kernel-toolchains"}
...
export JBOX_CLANG_SHA256="$toolchain_clang_sha" JBOX_SYSROOT_SHA256="$toolchain_sysroot_sha"
