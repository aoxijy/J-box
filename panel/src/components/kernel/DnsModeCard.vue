...
import type { JBoxDnsMode, JBoxProfile } from '@/api/jbox'
...
const NOTE_KEY: Record<JBoxDnsMode, string> = {
...
const mode = computed<JBoxDnsMode>(() => props.profile.dns?.mode ?? 'dnsmasq')
...
const onChange = async (event: Event) => {
  const next = (event.target as HTMLSelectElement).value as JBoxDnsMode
