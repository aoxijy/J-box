...
import type { JBoxKernelVersion, JBoxServiceStatus } from '@/api/jbox'
...
defineProps<{
  status: JBoxServiceStatus | null
  kernelVersion: JBoxKernelVersion | null
}>()
