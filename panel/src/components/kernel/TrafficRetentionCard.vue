...
import { fetchTrafficUsage, type JBoxProfile, type JBoxTrafficUsage } from '@/api/jbox'
...
const monthsOf = (p: JBoxProfile) => p.traffic?.keepMonths ?? DEFAULT_MONTHS
const months = ref(monthsOf(props.profile))
const usage = ref<JBoxTrafficUsage | null>(null)
