...
import type { JBoxLatencyResult, JBoxRenameOptions, JBoxSubscriptionPreview, JBoxSkippedNode } from '@/api/jbox'
import { testNodeLatency } from '@/api/jbox'
...
const props = defineProps<{
  ...
  loading: boolean
  error: string
  preview: JBoxSubscriptionPreview | null
...
const skippedText = (item: JBoxSkippedNode) => {
...
// 覆盖表三者都靠它对齐。
const latency = ref<Record<string, JBoxLatencyResult>>({})
