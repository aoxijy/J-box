...
import { checkServerPort, type JBoxServer, type JBoxServerProtocol } from '@/api/jbox'
...
const emit = defineEmits<{
  ...
  saved: [server: JBoxServer]
}>()

const PROTOCOLS: { value: JBoxServerProtocol; label: string }[] = [
...
const DEFAULT_PORT: Record<JBoxServerProtocol, number> = { shadowsocks: 8388, vless: 8443, tuic: 8444, hysteria2: 8445, mixed: 7080 }
...
const form = reactive<JBoxServer>(blank())
