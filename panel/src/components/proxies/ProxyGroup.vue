...
import { managedOutbounds, siteSetNames } from '@/store/jboxSiteSets'
import { failoverCurrentLaneId, failoverLanesOf, failoverLastSwitchText, failoverMembersOf, isFailoverGroup, watchFailoverStatus } from '@/store/jboxFailover'
...
const { t } = useI18n()
// 节点管理里的这个组(有就是 J-Box 自己生成的组,没有就是内核配置里别的出站)
