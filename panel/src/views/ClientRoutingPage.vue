...
const persist = async (next: JBoxClientRoute[]) => {
  try {
...
const openEdit = (r: JBoxClientRoute) => {
  editing.value = r
  dialogOpen.value = true
}
const onSaved = (r: JBoxClientRoute) => {
