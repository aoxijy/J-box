...
import type { JBoxKernelVersion, JBoxProfile, JBoxServiceStatus } from '@/api/jbox'
import { fetchKernelVersion, fetchProfile, saveProfile } from '@/api/jbox'
...
import JBoxUpdateCard from '@/components/kernel/JBoxUpdateCard.vue'
...
const status = ref<JBoxServiceStatus | null>(null)
const kernelVersion = ref<JBoxKernelVersion | null>(null)
const profile = ref<JBoxProfile | null>(null)
...
const patchProfile = async (patch: Record<string, unknown>): Promise<JBoxProfile> => {
