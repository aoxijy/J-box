...
import { deleteSubscription, fetchSubscriptions, fetchSubscriptionShares, refreshSubscription, reorderSubscriptions, updateSubscription } from '@/api/jbox'
...
import { loadJBoxNodeGroups } from '@/store/jboxSiteSets'
...
const subscriptions = ref<JBoxSubscription[]>([])
const shares = ref<JBoxSubscriptionShare[]>([])
...
const handleToggle = async (sub: JBoxSubscription, enabled: boolean) => {
  try {
...
const pendingDelete = ref<JBoxSubscription | null>(null)
const deleting = ref(false)

const requestDelete = (sub: JBoxSubscription) => {
