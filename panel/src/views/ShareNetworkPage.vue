...
const servers = ref<JBoxServer[]>([])
const loading = ref(true)
const dialogOpen = ref(false)
const editing = ref<JBoxServer | null>(null)

const PROTOCOL_LABEL: Record<JBoxServerProtocol, string> = {
...
const protocolLabel = (p: JBoxServerProtocol) => PROTOCOL_LABEL[p] || p
...
const persist = async (next: JBoxServer[]) => {
  try {
...
const openEdit = (s: JBoxServer) => {
  editing.value = s
  dialogOpen.value = true
}
const onSaved = (s: JBoxServer) => {
