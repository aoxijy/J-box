...
import JBoxUpdateDialog from './components/kernel/JBoxUpdateDialog.vue'
import { resumeUpdateWatch } from './composables/jboxUpdate'
...
// 见模板里 JBoxUpdateDialog 的说明:Teleport 目标就是根节点自己,得等它进了文档再挂
...
<template>
  ...
  >
    ...
    <JBoxUpdateDialog v-if="appMounted" />
    <div
      ref="toast"
