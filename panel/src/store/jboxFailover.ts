import type { JBoxFailoverGroupStatus, JBoxFailoverStatus } from '@/api/jbox'
import { fetchFailoverStatus } from '@/api/jbox'
import { i18n } from '@/i18n'
import { managedOutbounds } from '@/store/jboxSiteSets'
...
export const failoverStatus = ref<JBoxFailoverStatus | null>(null)
export const failoverGroupByTag = computed(() => {
  const map = new Map<string, JBoxFailoverGroupStatus>()
