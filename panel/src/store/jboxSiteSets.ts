...
// 会被当成策略组,跑到「策略」页签里去。
//
// J-Box 自己知道哪些 selector 是站点集(routing.policies + 兜底「其他」),不用猜。
...
export const loadJBoxSiteSets = async () => {
  try {
