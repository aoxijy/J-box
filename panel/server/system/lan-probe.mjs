...
export const PROBE_NETNS = 'jbox-probe'
export const PROBE_VETH_HOST = 'obprobe0'
export const PROBE_VETH_NS = 'obprobe1'
// 本地管理位的固定 MAC:每次都拿同一个 DHCP 租约,DHCP 表里只出现一台「jbox-probe」
export const PROBE_MAC = '02:4f:42:00:00:01'
export const PROBE_HOSTNAME = 'jbox-probe'
export const PROBE_DHCP_SCRIPT = '/tmp/jbox-probe-dhcp.sh'
