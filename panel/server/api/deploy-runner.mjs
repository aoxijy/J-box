...
export const buildCurrentConfig = (store, systemDns, { geoDir = createPaths(process.env.JBOX_ROOT).geoDir, cacheFilePath, selections, tlsCert, localSubnets = [], directHostCidrs = [], ruleLists = {}, profilePatch, nativeBypass } = {}) => {
...
const LOCK_KEY = 'jbox/deploy-lock'
