...
// openwrt/initd/jbox-panel 一致:ZASHBOARD_DB_PATH、JBOX_ROOT。
...
const jboxRoot = process.env.JBOX_ROOT || '/opt/j-box'
...
const result = await runDeploy({ store, ctx: createRealContext(), paths: createPaths(jboxRoot) })
