...
export const buildConfig = ({ nodes, profile, userGroups, systemDns, localSubnets = [], directHostCidrs = [], subscriptions = [], ruleLists = {}, cacheFilePath = '/opt/j-box/data/cache.db', selections = {}, tlsCert = { certPath: '/opt/j-box/etc/certs/server.crt', keyPath: '/opt/j-box/etc/certs/server.key' }, nativeBypass, dnsFilter }) => {
